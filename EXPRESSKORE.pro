######################################################################
# Automatically generated by qmake (3.1) Thu Sep 27 16:36:44 2018
######################################################################
...
TRANSLATIONS += src/qt/locale/pivx_bg.ts \
                src/qt/locale/pivx_ca.ts \
                src/qt/locale/pivx_cs.ts \
                src/qt/locale/pivx_da.ts \
                src/qt/locale/pivx_de.ts \
                src/qt/locale/pivx_en.ts \
                src/qt/locale/pivx_en_US.ts \
                src/qt/locale/pivx_es.ts \
                src/qt/locale/pivx_es_ES.ts \
                src/qt/locale/pivx_fi.ts \
                src/qt/locale/pivx_fr_FR.ts \
                src/qt/locale/pivx_hi_IN.ts \
                src/qt/locale/pivx_hr.ts \
                src/qt/locale/pivx_hr_HR.ts \
                src/qt/locale/pivx_it.ts \
                src/qt/locale/pivx_ja.ts \
                src/qt/locale/pivx_ko_KR.ts \
                src/qt/locale/pivx_lt_LT.ts \
                src/qt/locale/pivx_nl.ts \
                src/qt/locale/pivx_pl.ts \
                src/qt/locale/pivx_pt.ts \
                src/qt/locale/pivx_pt_BR.ts \
                src/qt/locale/pivx_ro_RO.ts \
                src/qt/locale/pivx_ru.ts \
                src/qt/locale/pivx_sk.ts \
                src/qt/locale/pivx_sv.ts \
                src/qt/locale/pivx_tr.ts \
                src/qt/locale/pivx_uk.ts \
