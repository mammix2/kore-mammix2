...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    string bsas = demoAddress.ToString();
    UniValue retValue;
    ...
    string kjfh = setaccountDemoAddress.ToString();
    ...
    BOOST_CHECK_THROW(CallRPC("setaccount KJdsLBPJxKNwnnSRSHt45zE6153bYCwekg nullaccount"), runtime_error);
    BOOST_CHECK_THROW(CallRPC("setaccount"), runtime_error);
    /* D8w12Vu3WVhn543dgrUUf9uYu6HLwnPm5 (33 chars) is an illegal address (should be 34 chars) */
    BOOST_CHECK_THROW(CallRPC("setaccount KJdsLBPJxKNwnnSRSHt45zE6153bYCwek nullaccount"), runtime_error);
    ...
    BOOST_CHECK_THROW(CallRPC("signmessage KJdsLBPJxKNwnnSRSHt45zE6153bYCwekg mymessage"), runtime_error);

    /* missing arguments */
    BOOST_CHECK_THROW(CallRPC("verifymessage " + demoAddress.ToString()), runtime_error);
    BOOST_CHECK_THROW(CallRPC("verifymessage " + demoAddress.ToString() + " " + retValue.get_str()), runtime_error);
    /* Illegal address */
    BOOST_CHECK_THROW(CallRPC("verifymessage KJdsLBPJxKNwnnSRSHt45zE6153bYCwek " + retValue.get_str() + " mymessage"), runtime_error);
    /* wrong address */
    BOOST_CHECK(CallRPC("verifymessage KJdsLBPJxKNwnnSRSHt45zE6153bYCwekg " + retValue.get_str() + " mymessage").get_bool() == false);
