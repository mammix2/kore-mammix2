...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "     \"5\" : n,            (numeric) supply of 5 zKORE denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zKORE denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zKORE denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zKORE denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zKORE denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zKORE denomination\n"
...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"koreaddress\"\n"
            "\nReturn information about the given kore address.\n"

            "\nArguments:\n"
            "1. \"koreaddress\"     (string, required) The kore address to validate\n"

            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"koreaddress\", (string) The kore address validated\n"
...
#ifdef ENABLE_WALLET
        // Case 1: KORE address and we have full public key:
...
UniValue createmultisig(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2)
        throw runtime_error(
            ...
            "2. \"keys\"       (string, required) A json array of keys which are kore addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"key\"    (string) kore address or hex-encoded public key\n"
            "       ,...\n"
            "     ]\n"
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"koreaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"

            "\nArguments:\n"
            "1. \"koreaddress\"  (string, required) The kore address to use for the signature.\n"
