...
UniValue getchaintxstats(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() > 2)
        throw std::runtime_error(
            ...
            "2. blockhash         (String Hex, optional, default=chain tip) The hash of the block that ends the window.\n"
...
UniValue getrawmempool(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "    \"fee\" : n,              (numeric) transaction fee in kore\n"
...
UniValue gettxout(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 3)
        throw runtime_error(
            ...
            "     \"addresses\" : [          (array of string) array of kore addresses\n"
            "     \"koreaddress\"   	 	(string) kore address\n"
            "        ,...\n"
            "     ]\n"
            "  },\n"
