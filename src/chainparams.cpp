...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of(0, uint256S("0x0aab10677b4fe0371a67f99e78a69e7d9fa03a1c7d48747978da405dc5abeb99"))(5, uint256S("0x00eaaa465402e6bcf745c00c38c0033a26e4dea19448d9109e4555943d677a31"))(1000, uint256S("0x2073f0a245cedde8344c2d0b48243a58908ffa50b02e2378189f2bb80037abd9")) // ,last PoW block, begin of PoS
    (40000, uint256S("0x572b31cc34f842aecbbc89083f7e40fff6a07e73e6002be75cb95468f4e3b4ca"))(80000, uint256S("0x070aa76a8a879f3946322086a542dd9e4afca81efafd7642192ed9fe56ba74f1"))(120000, uint256S("0x70edc85193638b8adadb71ea766786d207f78a173dd13f965952eb76932f5729"))(209536, uint256S("0x8a718dbb44b57a5693ac70c951f2f81a01b39933e3e19e841637f757598f571a"));
...
static Checkpoints::MapCheckpoints mapCheckpointsTestnet =
    boost::assign::map_list_of(0, uint256("0x000ce3b76d9435adbc2713c62239cea20fe6bf0f69ed4d4f5c95ef07018a0450"));
...
public:
    CMainParams()
    {
        ...
        nMajorityBlockUpgradeEnforce                  = 750;                 // consensus.nMajorityEnforceBlockUpgrade = 750;
        nMajorityBlockUpgradeToCheck                  = 1000;                // consensus.nMajorityWindow = 1000;
        nMajorityBlockOutdatedReject                  = 950;                 // consensus.nMajorityRejectBlockOutdated = 950;
        ...
        nSporkKeyRejectOld                            = 1527811200;          //!> Fully reject old spork key after (GMT): Friday, June 1, 2018 12:00:00 AM
        ...
        LogPrintf("%s", nHashGenesisBlock.ToString());
        genesis.print();
        assert(nHashGenesisBlock      == uint256("0x0a9ab95126cdf38d00973715c656e5f27e35ed17bc13e3ac061afda26e3a7cb9"));
...
public:
    CTestNetParams()
    {
        ...
        nMajorityBlockUpgradeEnforce                  = 51;
        nMajorityBlockOutdatedReject                  = 75;
        ...
        nCoinbaseMaturity = nStakeMinConfirmations    = 10;                          // Lico should be25;
        nMaxTipAge                                    = 0x7fffffff;
        nMinerThreads                                 = 0;
        nModifierInterval                             = 15;                          // Modifier interval: time to elapse before new modifier is computed
        nPastBlocksMax                                = 64;
        nPastBlocksMin                                = 64;
        ...
        nSporkKeyRejectOld                            = 1522454400;                  //!> Reject old spork key after Saturday, March 31, 2018 12:00:00 AM GMT
        ...
        nClientMintableCoinsInterval                  = 10 + 2;                      // Every 10 seconds
...
public:
    CRegTestParams()
    {
        ...
        nMajorityBlockOutdatedReject   = 950;              // consensus.nMajorityRejectBlockOutdated
        nMajorityBlockUpgradeEnforce   = 750;              // consensus.nMajorityEnforceBlockUpgrade
